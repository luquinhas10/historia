function escolherAcao() {
    ...
    document.querySelector(".choices").innerHTML = `
        <button onclick="escolherEsquerda()">Examine o mapa para tentar entender onde está.</button>
        <button onclick="escolherDireita()">Segue sem olhar o mapa</button>
    `;
}
